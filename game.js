(() => {
  ...
  function returnMenu() { state = "menu"; show(screens.menu); $("hud").classList.add("hidden"); $("menuHighScore").textContent = best.toLocaleString(); }
  function togglePause() { if (state === "play") { state = "pause"; show(screens.pause); } else if (state === "pause") { state = "play"; show(null); } }
